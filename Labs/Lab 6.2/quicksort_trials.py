...
def average_times(list_of_ns, pivot_type, randomise_numbers):
    """Runs quicksort tests to work out the average time to sort a list of size
       n based on its pivot and whether or not the list is randomised.
    """
    avg_times = []
...
avg_times_lps = average_times(list_of_ns, 'left-pivot', False)
avg_times_lpr = average_times(list_of_ns, 'left-pivot', True)
avg_times_mo3s = average_times(list_of_ns, 'mo3-pivot', False)
avg_times_mo3r = average_times(list_of_ns, 'mo3-pivot', True)
...
pyplot.plot(list_of_ns, avg_times_lpr, 'bo', list_of_ns, avg_times_mo3r, 'ro')
...
pyplot.plot(list_of_ns, avg_times_lps, 'bo', list_of_ns, avg_times_lpr, 'go',
            list_of_ns, avg_times_mo3s, 'ro', list_of_ns, avg_times_mo3r, 'mo')